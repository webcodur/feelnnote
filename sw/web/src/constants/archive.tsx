...
export const ARCHIVE_TABS: ArchiveTab[] = [
  ...
  },
  {
    ...
    description: "읽고, 보고, 듣고, 몰입한 기록.",
    subDescription: "한 사람의 서재를 들여다보세요. 그가 어떤 사람인지 보이기 시작합니다.",
    ownerDescription: "당신이 읽고, 보고, 듣고, 몰입한 기록.",
    ownerSubDescription: "기록은 쌓일수록 당신을 말해줍니다.",
  },
  {
    value: "interests",
    label: "관심",
    href: "/reading/interests",
    nonCeleb: true,
    title: "관심",
    englishLabel: "INTERESTS",
    description: "아직 닿지 않은, 그러나 마음에 둔 것들.",
    subDescription: "누군가의 관심사를 보면 그의 다음 행보가 보입니다.",
    ownerDescription: "언젠가 만나고 싶은 작품들.",
    ownerSubDescription: "관심은 미래의 기록이 됩니다.",
  },
  {
    value: "collections",
    label: "묶음",
